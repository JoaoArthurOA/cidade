let model = {
    ...
    board: {
      ...
      selected: null,
      positions: [],
      /*FUNÇÃO PARA MOVER A PEÇA BRANCA */
    ...
    /*FUNÇÃO PARA MOVER A PEÇA PRETA */
    ...
    /*FUNÇÃO PARA APRESENTAÇÃO DO TABULEIRO */
    drawBoard: function () {
        ...
        /*FOR PARA FAZER A MOVIMENTAÇÃO DO JOGO*/
        for (var i = 0; i < rows; i++) {
          for (var j = 0; j < columns; j++) {
        ...
        /*FUNÇÃO PRA MOVIMENTÇÃO DAS PEÇAS */
    putInitialPieces: function (pieces) {
      ...
      /*FUNÇÃO  PARA PERCORER AS POSIÇÕES EMPATE*/
    draw: function () {
      ...
      /*FUNÇÃO PARA SELECIONAR AS CELULAS */
    selectCell: function (row, column) {
      ...
      /*FUNÇÃO PARA DESLOCAR AS CELULAR */
    unselectCell: function () {
      ...
      /*FUNÇÃO PARA QUANDO AS PEÇAS ESTIVER FORA DO TABULEIRO */
  ...
  /*FUNÇÃO DO INICIO DAS POSICÕES DO TABULEIRO */
  var init = function () {
  model.board.initBoard(8, 8, 12);
  model.board.drawBoard();
   };

   /*FUNÇÃO PARA DEFINIR SE O JOGADOR GANHOU OU PERDEU */
